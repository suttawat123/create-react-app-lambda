...
import { fetchDataPos } from "../../services/Pos/action";
...
class ReportPos extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoadData: false,
  ...
  fetchPos = async (page) => {
    ...
    const { fetchDataPos } = this.props;

    let response = await fetchDataPos(page, this.state.code_bill);
...
const mapDispatchToProps = (dispatch) =>
  bindActionCreators(
    {
      fetchDataPos: fetchDataPos,
    },
    dispatch
  );

export default connect(mapStateToProps, mapDispatchToProps)(ReportPos);
